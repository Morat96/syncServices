...
cd createBench
mvn clean package -q
wsk -i action update benchdbJava/createBench target/main.jar --main Main --kind java:8 --web true
cd ..

echo "Creating DELETE action: deleteBench"
cd deleteBench
mvn clean package -q
wsk -i action update benchdbJava/deleteBench target/main.jar --main Main --kind java:8 --web true
cd ..

echo "Creating PUT action: updateBench"
cd updateBench
mvn clean package -q
wsk -i action update benchdbJava/updateBench target/main.jar --main Main --kind java:8 --web true
cd ..

echo "Creating GET action: readBench"
cd readBench
mvn clean package -q
wsk -i action update benchdbJava/readBench target/main.jar --main Main --kind java:8 --web true
cd ..