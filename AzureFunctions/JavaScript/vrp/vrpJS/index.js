...
module.exports = async function (context, req) {
    ...
    context.log('Vehicle Routing Problem solver.');
    ...
    if (!req.query.vns) {
        console.log("The parameter 'vns' is not defined!");
        return context.res = {
            status: 400,
            body: {
                'Error': "The parameter 'vns' is not defined!"
            }
        };
    }
    ...
    if(req.body) {
        ...
        console.log("An instance of a Vehicle Routing Problem must be upload with a POST method.");
        return context.res = {
            status: 400,
            body: {
