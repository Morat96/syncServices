...
exports.vrp = (req, res) => {
    ...
    if (!req.query.vns) {
        res.status(500).json({ error: 'The parameter \'vns\' must be defined!' })
    }
    ...
    // logs parameters
    console.log("VNS: " + vns);
    console.log("k_opt: " + k_opt);
    console.log("Iters: " + n_iter);
    ...
    if(req.body && req.body.length) {
        ...
        res.status(500).json({ error: 'An instance of a Vehicle Routing Problem must be upload with a POST method.' })
    }
